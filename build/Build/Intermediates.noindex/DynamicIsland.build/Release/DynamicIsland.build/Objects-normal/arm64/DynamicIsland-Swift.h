...
#ifndef DYNAMICISLAND_SWIFT_H
#define DYNAMICISLAND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DynamicIsland",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13DynamicIsland11AppDelegate")
...
SWIFT_CLASS("_TtC13DynamicIsland14DragHandleView")
...
SWIFT_CLASS("_TtC13DynamicIsland19DynamicIslandWindow")
@interface DynamicIslandWindow : NSPanel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (void)setFrame:(NSRect)frameRect display:(BOOL)display animate:(BOOL)animate;
...
SWIFT_CLASS("_TtC13DynamicIsland14WeatherService")
